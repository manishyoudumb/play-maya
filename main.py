    ...
    def run(self):
        ...
        if config.RECORD_HOTKEY:
            ...
            if "+" in config.RECORD_HOTKEY:
                ...
                print(f"\tHold down '{hotkey_start}' and double tap '{hotkey_end}' to give Maya the content currently copied in your clipboard.")
            else:
                print(f"\tDouble tap '{config.RECORD_HOTKEY}' to give Maya the content currently copied in your clipboard.")
