...
def main():
    ...
    if is_windows():
        ...
        add_to_startup_prompt = input("[?] Do you want to add MAYA to startup? (y/n): ")
        if add_to_startup_prompt.lower() == 'y':
            run_file = 'run_MAYA.bat'
